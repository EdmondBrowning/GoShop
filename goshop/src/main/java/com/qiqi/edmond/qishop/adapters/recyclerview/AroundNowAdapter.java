...
public class AroundNowAdapter extends BaseFooterAdapter<AroundNowInfo> {
    ...
    public AroundNowAdapter(Context context, List<AroundNowInfo> data, View footer) {
        super(context, data);
        this.footer = footer;
    }
    ...
    public BaseItem initItem(ViewGroup parent) {
        View view = getInflater().inflate(R.layout.item_around_now, parent, false);
