...
public class AroundNowModel extends BaseModel<AroundNowData> implements AroundNowModelInterface {
    @Override
    public void init(final AroundNowPresenter presenter) {
//        AroundNowInfo info1 = new AroundNowInfo();
//        AroundNowInfo info2 = new AroundNowInfo();
//        AroundNowInfo info3 = new AroundNowInfo();
//        AroundNowInfo info4 = new AroundNowInfo();
//        AroundNowInfo info5 = new AroundNowInfo();
//
//        info1.setCare(true);
...
//
//
//        getData().getAroundNowInfos().add(info1);
//        getData().getAroundNowInfos().add(info2);
//        getData().getAroundNowInfos().add(info3);
//        getData().getAroundNowInfos().add(info4);
...
//        presenter.inited(getData());
    ...
    @Override
    public void refresh(final AroundNowPresenter presenter) {
//        AroundNowInfo info1 = new AroundNowInfo();
//        AroundNowInfo info2 = new AroundNowInfo();
//        AroundNowInfo info3 = new AroundNowInfo();
//        AroundNowInfo info4 = new AroundNowInfo();
...
//        info5.setLogoUrl("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1487766424840&di=13c3ad552f88471e95641a77ece9154a&imgtype=0&src=http%3A%2F%2Fimg.qqu.cc%2Fuploads%2Fallimg%2F141214%2F1-1412141U502.jpg");
//
//        getData().getAroundNowInfos().clear();
//
//        getData().getAroundNowInfos().add(info1);
//        getData().getAroundNowInfos().add(info2);
//        getData().getAroundNowInfos().add(info3);
...
//        presenter.refreshed(getData());
    ...
    @Override
    public void loadMore(final AroundNowPresenter presenter) {
//        List<AroundNowInfo> aroundNowInfos = new ArrayList<>();
//        aroundNowInfos.add(new AroundNowInfo());
//        aroundNowInfos.add(new AroundNowInfo());
//        aroundNowInfos.add(new AroundNowInfo());
//        aroundNowInfos.add(new AroundNowInfo());
//        aroundNowInfos.add(new AroundNowInfo());
...
//        presenter.loadMored(aroundNowInfos);
        ...
        StringNetWork stringNetWork = new StringNetWork(0, Api.AROUND_NOW_MORE, new BaseStringListener<AroundNowInfoMore>() {
            ...
            @Override
            public void onSucceed(int what, AroundNowInfoMore response) {
                presenter.loadMored(response.getAroundNowInfos());
            }
