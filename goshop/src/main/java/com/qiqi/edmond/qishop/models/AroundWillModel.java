...
public class AroundWillModel extends BaseModel<AroundWillData> implements AroundWillModelInterface{
    @Override
    public void init(AroundWillPresenter presenter) {
    ...
    @Override
    public void refresh(AroundWillPresenter presenter) {
        AroundWillInfo info1 = new AroundWillInfo();
        AroundWillInfo info2 = new AroundWillInfo();
        AroundWillInfo info3 = new AroundWillInfo();
        AroundWillInfo info4 = new AroundWillInfo();
    ...
    @Override
    public void loadMore(AroundWillPresenter presenter) {
        List<AroundWillInfo> aroundWillInfos = new ArrayList<>();
        aroundWillInfos.add(new AroundWillInfo());
        aroundWillInfos.add(new AroundWillInfo());
        aroundWillInfos.add(new AroundWillInfo());
        aroundWillInfos.add(new AroundWillInfo());
        aroundWillInfos.add(new AroundWillInfo());
        getData().getAroundWillInfos().addAll(aroundWillInfos);
        presenter.loadMored(aroundWillInfos);
    }
}
