...
public class AroundPastModel extends BaseModel<AroundPastData> implements AroundPastModelInterface{
    @Override
    public void init(AroundPastPresenter presenter) {

        AroundPastInfo info1 = new AroundPastInfo();
        AroundPastInfo info2 = new AroundPastInfo();
        AroundPastInfo info3 = new AroundPastInfo();
        AroundPastInfo info4 = new AroundPastInfo();
        AroundPastInfo info5 = new AroundPastInfo();
        ...
        getData().getAroundPastInfos().add(info1);
        getData().getAroundPastInfos().add(info2);
        getData().getAroundPastInfos().add(info3);
        getData().getAroundPastInfos().add(info4);
        getData().getAroundPastInfos().add(info5);
        presenter.inited(getData());
    }

    @Override
    public void refresh(AroundPastPresenter presenter) {
        AroundPastInfo info1 = new AroundPastInfo();
        AroundPastInfo info2 = new AroundPastInfo();
        AroundPastInfo info3 = new AroundPastInfo();
        AroundPastInfo info4 = new AroundPastInfo();
        ...
        getData().getAroundPastInfos().clear();
    ...
    @Override
    public void loadMore(AroundPastPresenter presenter) {
        List<AroundPastInfo> aroundPastInfoList = new ArrayList<>();
        aroundPastInfoList.add(new AroundPastInfo());
        aroundPastInfoList.add(new AroundPastInfo());
        aroundPastInfoList.add(new AroundPastInfo());
        aroundPastInfoList.add(new AroundPastInfo());
        aroundPastInfoList.add(new AroundPastInfo());
        getData().getAroundPastInfos().addAll(aroundPastInfoList);
        presenter.loadMored(aroundPastInfoList);
    }
}
